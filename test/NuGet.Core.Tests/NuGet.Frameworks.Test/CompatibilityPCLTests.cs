...
namespace NuGet.Test
{
    public class CompatibilityPCLTests
    {
        ...
        [InlineData("portable-net45+netcore45", "netstandard0.9.1", false)]
        [InlineData("portable-net45+netcore45", "netstandard0.9", false)]
        [InlineData("portable-net45+netcore45", "netstandard0.0", false)]
        [InlineData("portable-net45+netcore45", "netstandard", false)]
